...
def play_with_pygame():
    ...
    window, window_height, window_width, white_rect, white_rect_height, fond = display_function.init_display()
    WINDOWS = [window, window_height, window_width, white_rect, white_rect_height, fond]
